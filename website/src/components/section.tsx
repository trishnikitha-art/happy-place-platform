...
export function SectionHeading({
  ...
  return (
    <div className={cn("max-w-2xl", align === "center" && "mx-auto text-center")}>
      ...
      <h2 className="mt-5 font-display text-4xl font-bold leading-[1.08] tracking-tight text-[#17324A] sm:text-5xl">{title}</h2>
      {description && <p className="mt-6 text-lg text-[#000000] sm:text-xl leading-relaxed">{description}</p>}
    </div>
  );
}
