...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (!media) {
      console.log('[BRAND HERO] KV media not found, checking static authority', { mediaId });
      ...
      if (staticMedia) {
        console.log('[BRAND HERO] Using static media from authority', { mediaId });
      } else {
        console.error('[BRAND HERO] Media not found in KV or static authority', { mediaId });
        return NextResponse.json(
