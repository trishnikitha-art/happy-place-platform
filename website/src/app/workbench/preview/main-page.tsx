...
import { ServiceCard } from "@/app/workbench/preview/main-service-card";
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* TRUST STRIP G�� quiet, confident proof (woven, not a banner) */}
      <ScrollReveal>
      ...
      {/* SERVICES G�� image-dominant cards, less chrome (Directive 034) */}
      <ScrollReveal>
        <Section className="relative bg-[#F6F4F0] pt-8 sm:pt-10 pb-8 sm:pb-10 section-diagonal-top">
          ...
          <Container className="relative z-10">
            <SectionHeading
              ...
              description="Pick a service to start a free estimate G�� we'll guide you through the rest."
      ...
      {/* FEATURED PROJECTS G�� bento grid layout */}
      <ScrollReveal>
      ...
      {/* THE FAMILY G�� philosophy first, then people, then portrait (Act II) */}
      <ScrollReveal>
          ...
          <Container className="relative z-10 grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="measure mt-7 space-y-5 text-primary">
                ...
                <p>
                  <span className="font-semibold text-primary">{taylor.name}</span> G�� Taylor cares about the work you'll notice five years from now, not just on the day it passes inspection.
                </p>
                <p>
                  <span className="font-semibold text-primary">{lanie.name}</span> G�� Lanie keeps every project organized so you always know what's happening, what's next, and who to call.
                </p>
              </div>
            </div>
      ...
      {/* NEWSLETTER SIGNUP G�� positioned 2/3 down after visitors see who we are, projects, testimonials, services */}
      <ScrollReveal>
