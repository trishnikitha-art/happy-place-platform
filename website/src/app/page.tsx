      ...
      <section className="relative isolate overflow-hidden bg-deep text-text-on-dark">
        ...
        <Container className="relative z-10 flex min-h-[75svh] sm:min-h-[82svh] lg:min-h-[88svh] flex-col justify-center py-12 sm:py-16 lg:py-20">
          <div className="max-w-3xl">
            <p className="font-signature text-xl sm:text-2xl text-text-on-dark tracking-wide relative inline-block">
              <span className="relative z-10 bg-gradient-to-br from-[#A67C00] via-[#D99A4E] via-[#E7AD63] to-[#F0C070] bg-clip-text text-transparent animate-shimmer-slow" style={{ backgroundSize: '200% 100%' }}>
                Happy Place Carpentry
              </span>
              <span className="absolute inset-0 z-20 bg-gradient-to-r from-transparent via-white/15 via-white/10 to-transparent bg-clip-text text-transparent pointer-events-none animate-shimmer-slow" style={{ backgroundSize: '200% 100%' }}>
                Happy Place Carpentry
              </span>
            </p>
